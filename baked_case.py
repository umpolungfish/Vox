...
def _build_case(n, mode, width):
    ...
    target_bin = {'phaseB': 'phaseB_fac', 'winding': 'winding_membrane', 'ring': 'ring_membrane', 'basemod': 'base_mod_membrane', 'reduce': 'reduce_delete_membrane'}.get(mode, 'semiprime_probe')
